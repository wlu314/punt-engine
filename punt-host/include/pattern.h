...
static inline pattern_t pack_pattern(OrderType order_type, uint16_t price, uint16_t quantity) {
    pattern_t pattern = 0;
...
static inline void unpack_pattern(pattern_t pattern, OrderType *order_type, uint16_t *price, uint16_t *quantity) {
